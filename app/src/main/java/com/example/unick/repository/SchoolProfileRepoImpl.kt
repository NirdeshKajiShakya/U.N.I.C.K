...
class SchoolProfileRepoImpl : SchoolProfileRepo {
    ...
    override fun observeSchoolProfile(
        schoolId: String,
    ...
    override fun updateSchoolProfile(
        schoolId: String,
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    val list = snapshot.children.mapNotNull {
                        it.getValue(SchoolGalleryModel::class.java)
                    }
                    onData(list)
                }
    ...
    override fun observeReviews(
        ...
        db.child("school_reviews").child(schoolId)
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    val list = snapshot.children.mapNotNull {
                        it.getValue(SchoolReviewModel::class.java)
                    }
    ...
    // ✅ UPDATED SIGNATURE (matches interface)
